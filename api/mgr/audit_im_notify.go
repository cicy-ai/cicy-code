...
//
// 2.1.8: dropped the separate security-officer agent. The merged audit advisor
// (now w-6001, reclaiming the officer's slot) handles both triage and human
// coordination, so there's nothing to escalate cross-agent.
