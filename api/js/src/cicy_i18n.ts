...
const STRINGS: Record<Lang, Record<string, string>> = {
  en: {
    ...
    restartPaneTitle: "Restart Agent",
    launchAgentTitle: "Launch {agent}",
    updateAgentTitle: "Update {agent}",
    updatePreparing: "Preparing…",
    updateInstalling: "Updating…",
    updateFailed: "Update failed",
    updateFailedRetry: "Switch mirror & retry",
    updateDoneAskRestart: "✅ Update complete — restart {agent} now to use the new version?",
  ...
  "zh-CN": {
    ...
    updateFailed: "更新失败",
    updateFailedRetry: "切换镜像源重试",
    updateDoneAskRestart: "✅ 升级完成 — 现在重启 {agent} 启用新版本?",
