...
const config = {
  ...
  codeServerBase: import.meta.env.VITE_CODE_SERVER_BASE  || (apiOrigin ? apiOrigin + '/code' : 'https://dev-api.cicy-ai.com/code'),
  hostHome:       import.meta.env.VITE_HOST_HOME         || '/home/w3c_offical',
  desktopBase:    import.meta.env.VITE_DESKTOP_BASE      || apiOrigin || 'https://dev.cicy-ai.com',
  sttBase:        import.meta.env.VITE_STT_BASE          || apiOrigin || 'https://dev-api.cicy-ai.com',
  pollInterval:   5000,
