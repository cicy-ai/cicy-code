...
// ConfirmModal was retired — confirm() in app/src/components/ui/Modal.tsx
// is now the single confirm-dialog implementation for the whole app. See the
// useDialogs() hook for the promise-style API.
