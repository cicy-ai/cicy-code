...
const api = {
  ...
  getNpmAccounts: () => http.get('/api/npm/accounts'),
  saveNpmAccount: (body: { name: string; old_name?: string; email?: string; api_token?: string; "2fa"?: string; profile?: string; password?: string; registry?: string; scope?: string }) => http.put('/api/npm/accounts', body),
  deleteNpmAccount: (name: string) => http.delete('/api/npm/accounts', { params: { name } }),
  testNpmAccount: (name: string) => http.post('/api/npm/accounts/test', { name }),
  getNpmAccountTOTP: (name: string) => http.post('/api/npm/accounts/totp', { name }),
  getNpmAccountUsage: (name: string) => http.post('/api/npm/accounts/usage', { name }),
  bindNpmAccount: (name: string) => http.post('/api/npm/accounts/bind', { name }),
  getNpmAccountToken: (name: string) => http.get('/api/npm/accounts', { params: { reveal_token: name } }),
  inspectNpmAccount: (body: { name?: string; api_token?: string; registry?: string }) => http.post('/api/npm/accounts/inspect', body),
  getDockerAccounts: () => http.get('/api/docker/accounts'),
  saveDockerAccount: (body: { name: string; old_name?: string; username?: string; email?: string; api_token?: string; "2fa"?: string; profile?: string; password?: string; registry?: string }) => http.put('/api/docker/accounts', body),
  deleteDockerAccount: (name: string) => http.delete('/api/docker/accounts', { params: { name } }),
  testDockerAccount: (name: string) => http.post('/api/docker/accounts/test', { name }),
  getDockerAccountTOTP: (name: string) => http.post('/api/docker/accounts/totp', { name }),
  getDockerAccountUsage: (name: string) => http.post('/api/docker/accounts/usage', { name }),
  bindDockerAccount: (name: string) => http.post('/api/docker/accounts/bind', { name }),
  getDockerAccountToken: (name: string) => http.get('/api/docker/accounts', { params: { reveal_token: name } }),
  inspectDockerAccount: (body: { name?: string; username?: string; api_token?: string; registry?: string }) => http.post('/api/docker/accounts/inspect', body),
  getAliyunAccounts: () => http.get('/api/aliyun/accounts'),
  saveAliyunAccount: (body: { name: string; old_name?: string; access_key_id?: string; access_key_secret?: string; region?: string; account?: string; email?: string; "2fa"?: string; profile?: string; password?: string }) => http.put('/api/aliyun/accounts', body),
  deleteAliyunAccount: (name: string) => http.delete('/api/aliyun/accounts', { params: { name } }),
  testAliyunAccount: (name: string) => http.post('/api/aliyun/accounts/test', { name }),
  getAliyunAccountTOTP: (name: string) => http.post('/api/aliyun/accounts/totp', { name }),
  getAliyunAccountUsage: (name: string) => http.post('/api/aliyun/accounts/usage', { name }),
  bindAliyunAccount: (name: string) => http.post('/api/aliyun/accounts/bind', { name }),
  getAliyunAccountSecret: (name: string) => http.get('/api/aliyun/accounts', { params: { reveal_token: name } }),
  inspectAliyunAccount: (body: { name?: string; access_key_id?: string; access_key_secret?: string; region?: string }) => http.post('/api/aliyun/accounts/inspect', body),
